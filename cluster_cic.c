...
main(int argc,char **argv)
{
  ...
  double **xi_jacks,xi_full[NBINMAX1],e8[NBINMAX1],xi_avg[NBINMAX1],xnp,**random_pairs;
  ...
  /* screw this, always have LOS axis be z-axis
   */
  iauto=0 ;
  ...
  */
  for (kbin=0;kbin<nbin;kbin++)  {	/* loop over radial bins */
    ...
    // want xi as number per cluster minus background
    xi=(weight0-weightrandom)/np2;
